...
/**
 * Main program. Basically just parses the command line and then creates a
 * WashingMachineSimulation and a WashingController.
 * 
...
public class Wash {
	 ...
	 * <DL>
	 * <DT>-speed N
	 * <DD>Speeds up simulation N times.
	 * <DT>-hackermode
	 * <DD>Adds a panel with a few useful buttons.
	 * <DT>-help
	 * <DD>Does NOT provide any help.
	 * </DL>
	 * 
	 * @exception NumberFormatException
	 *                When the numeric speed argument fails.
	 * @exception InterruptedException
	 *                Won't happen, I'm just too lazy to catch it.
	 */
	public static void main(String[] args) throws NumberFormatException,
		...
		AbstractWashingMachine theMachine = new WashingMachineSimulation(
				theSpeed, freakShowProbability);
		...
		theMachine
				.setButtonListener(new WashingController(theMachine, theSpeed));
		theMachine.start();
